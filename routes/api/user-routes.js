...
const { User, Composition, Instrument } = require('../../models');
const withAuth = require('../../utils/auth');
const { getAllUsers, getOneUser, addUser, updateUser, deleteUser, login, logout } = require('../../controllers/api-controllers/user-controller');
