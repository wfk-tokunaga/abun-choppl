...
const { getAllInstruments, getOneInstrument, createInstrument, deleteInsrument } = require('../../controllers/api-controllers/instrument-controller');
...
router.route('/:id')
    .get(getOneInstrument)
    .delete(deleteInsrument);
